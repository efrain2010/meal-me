...
var App = () => {
  return /* @__PURE__ */ import_react.default.createElement("div", null, "This is the init of the React App");
};
...
app.use("/", (_, res) => {
  const appString = import_server.default.renderToString(/* @__PURE__ */ import_react2.default.createElement(App, null));
  res.send(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
